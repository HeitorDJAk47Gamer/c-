...
**Learning:** Users in locales using commas for decimal separators will naturally input numbers like 7,5. Standard parsing truncates this, causing errors. Normalizing commas to dots prevents this.
**Action:** Always sanitize floating-point input by replacing commas with dots in CLI tools for Portuguese users.
