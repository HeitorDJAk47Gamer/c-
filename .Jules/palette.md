...
**Learning:** In Portuguese CLI applications, users intuitively input floating-point numbers using commas. Standard C parsing functions like sscanf expect dots, leading to silent truncation and frustration. Intercepting and normalizing commas to dots significantly improves usability and error prevention.
**Action:** Always replace commas with dots before parsing floating-point input in localized C/C++ applications.
