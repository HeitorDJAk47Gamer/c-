...
## 2024-05-19 - Localized Decimal Input Handling
**Learning:** Users in Portuguese locales naturally use commas as decimal separators. Standard C functions often fail to parse this correctly, leading to poor UX and truncated inputs.
**Action:** Always intercept and replace commas with dots in CLI string buffers before parsing as floats to seamlessly support localized decimal input.
